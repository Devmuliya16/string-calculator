    ...
    <>
      <section className="bg-brand-light w-full h-full grid md:grid-cols-2 md:grid-rows-1 grid-rows-2 ">
        <motion.div
          ...
          className="w-full flex flex-col justify-center p-8">
        ...
        <div className="w-full flex flex-col items-center px-4">
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            className="drop-shadow-lg rounded-xl border-4 h-2/6 w-full content-center border-gray-600 p-5 md:p-10 m-4">
          ...
          <motion.div
            initial={{ opacity: 0, }}
            whileInView={{ opacity: 1 }}
            className="drop-shadow-lg rounded-xl border-4 h-3/6 w-full content-center border-gray-600 p-5 md:p-10 m-4">
